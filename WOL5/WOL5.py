...
basin_gdf = gpd.read_file(r"C:\Users\carsk\OneDrive - KU Leuven\Thesis\RESULTS\WOL5\basin.shp")
...
filtered_runoff_time_series.to_csv("C:\\Users\\carsk\\OneDrive - KU Leuven\\Thesis\RESULTS\WOL5\RO_norouting\\runoff_time_series.csv")
...
ax1.bar(precip_time_series.index, precip_time_series, color='r', label='Precipitation', alpha=0.5)
ax1.set_xlabel('Date')
...
fig.savefig("precipitation_runoff_time_series.png")
